*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZMALV_SFUT_RECV
*   generation date: 12/23/2020 at 07:44:29
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZMALV_SFUT_RECV     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZMALV_SFUT_RECV'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZMALV_SFUT_RECV_EXTRACT
TOTAL = ZMALV_SFUT_RECV_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZMALV_SFUT_RECV'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZMALV_SFUT_RECV-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMALV_SFUT_RECV_EXTRACT
TOTAL = ZMALV_SFUT_RECV_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZMALV_SFUT_RECV-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZMALV_SFUT_RECV'
...
TOTAL = ZMALV_SFUT_RECV_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZMALV_SFUT_RECV-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZMALV_SFUT_RECV-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZMALV_SFUT_RECV'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZMALV_SFUT_RECV-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMALV_SFUT_RECV_EXTRACT
TOTAL = ZMALV_SFUT_RECV_TOTAL
