*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZMALV_SFUT_EMAIL
*   generation date: 12/22/2020 at 14:23:28
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZMALV_SFUT_EMAIL    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZMALV_SFUT_EMAIL'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZMALV_SFUT_EMAIL_EXTRACT
TOTAL = ZMALV_SFUT_EMAIL_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZMALV_SFUT_EMAIL'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZMALV_SFUT_EMAIL-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMALV_SFUT_EMAIL_EXTRACT
TOTAL = ZMALV_SFUT_EMAIL_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZMALV_SFUT_EMAIL-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZMALV_SFUT_EMAIL'
...
TOTAL = ZMALV_SFUT_EMAIL_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZMALV_SFUT_EMAIL-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZMALV_SFUT_EMAIL-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZMALV_SFUT_EMAIL'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZMALV_SFUT_EMAIL-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMALV_SFUT_EMAIL_EXTRACT
TOTAL = ZMALV_SFUT_EMAIL_TOTAL
