*----------------------------------------------------------------------*
***INCLUDE LZMA0V_SFUT_EMAILF01.
*----------------------------------------------------------------------*

FORM set_email_body .

  DATA lt_sfut_email LIKE TABLE OF zma0v_sfut_email_extract.
...
* the data within the "extract" internal table
  ...
  zma0_cl_sfut_email_helper=>factory(
...
FORM handle_email_button.
  ...
  DATA lw_current_line LIKE LINE OF zma0v_sfut_email_extract.
...
FORM delete_text_component.
  ...
  DATA lt_sfut_email LIKE TABLE OF zma0v_sfut_email_total.
