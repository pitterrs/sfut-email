*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZMA0V_SFUT_REAS
*   generation date: 01/29/2021 at 11:04:43
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZMA0V_SFUT_REAS     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZMA0V_SFUT_REAS'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZMA0V_SFUT_REAS_EXTRACT
TOTAL = ZMA0V_SFUT_REAS_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZMA0V_SFUT_REAS'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZMA0V_SFUT_REAS-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMA0V_SFUT_REAS_EXTRACT
TOTAL = ZMA0V_SFUT_REAS_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZMA0V_SFUT_REAS-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZMA0V_SFUT_REAS'
...
TOTAL = ZMA0V_SFUT_REAS_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZMA0V_SFUT_REAS-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZMA0V_SFUT_REAS-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZMA0V_SFUT_REAS'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZMA0V_SFUT_REAS-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMA0V_SFUT_REAS_EXTRACT
TOTAL = ZMA0V_SFUT_REAS_TOTAL
