*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZMALV_SFUT_SEND
*   generation date: 01/15/2021 at 08:09:07
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZMALV_SFUT_SEND     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZMALV_SFUT_SEND'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZMALV_SFUT_SEND_EXTRACT
TOTAL = ZMALV_SFUT_SEND_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZMALV_SFUT_SEND'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZMALV_SFUT_SEND-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMALV_SFUT_SEND_EXTRACT
TOTAL = ZMALV_SFUT_SEND_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZMALV_SFUT_SEND-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZMALV_SFUT_SEND'
...
TOTAL = ZMALV_SFUT_SEND_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZMALV_SFUT_SEND-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZMALV_SFUT_SEND-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZMALV_SFUT_SEND'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZMALV_SFUT_SEND-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMALV_SFUT_SEND_EXTRACT
TOTAL = ZMALV_SFUT_SEND_TOTAL
